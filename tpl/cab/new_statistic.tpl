          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Создание статистики</h3>
                </div>
            ...
            <div style="padding-left: 20px; padding-right: 20px;">
              <form id="statEdit" method="POST" action="?a=save">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="">Название статистики</label>
                      <input type="text" name="statName" placeholder="Название статистики" class="form-control" value=""/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="statElName" placeholder="Название элемента статистики" class="form-control" value=""/>
                    </div>
                  </div>
                </div>
                <div class="row">
